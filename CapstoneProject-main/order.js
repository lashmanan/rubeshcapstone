...
/*getPrice = function() {
  ...
  Discount =15;
  var input = document.getElementById('in').value;
  var total= Fprice - (Fprice * Discount /100);
...
{
    const Fprice = document.getElementById('message').value;
    const Dprice = document.getElementById('err').value;
    const discount = document.getElementById('discount-Fprice');
    const FinalPay = document.getElementById('pay');
    discount.value = Fprice * Dprice / 100;
    FinalPay= Fprice - discount.value;
};
